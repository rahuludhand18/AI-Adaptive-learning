...
import { Play, Pause, Maximize2, Minimize2, RotateCcw, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!ended && <div className="absolute inset-0 z-10 cursor-pointer" onClick={togglePlay} />}
