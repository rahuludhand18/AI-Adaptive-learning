          ...
          <div className="lg:col-span-5 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-border dark:border-slate-800 shadow-card space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 text-xs">
                ...
                <div>
                  <h4 className="font-bold text-textPrimary dark:text-slate-100">Data Structures: Review Trees</h4>
                  <p className="text-textSecondary dark:text-slate-400 text-[11px]">Yesterday, 4:00 PM - 5:30 PM</p>
                </div>
              </div>

              <div className="flex items-start space-x-3 text-xs pt-3 border-t border-slate-100 dark:border-slate-800">
                <XCircle className="w-4 h-4 text-rose-500 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-bold text-textPrimary dark:text-slate-100">Calculus III: Practice Set 4</h4>
                  <p className="text-textSecondary dark:text-slate-400 text-[11px]">Yesterday, 7:00 PM - 8:30 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3 text-xs pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <div>
                  <h4 className="font-bold text-textPrimary dark:text-slate-100">Macroeconomics: Quiz prep</h4>
                  <p className="text-textSecondary dark:text-slate-400 text-[11px]">Today, 9:00 AM - 10:00 AM</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between text-xs">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-bold text-textPrimary dark:text-slate-100">Data Structures: Review Trees</h4>
                      <p className="text-indigo dark:text-indigo-400 font-medium text-[11px]">Today, 2:00 PM - 3:30 PM</p>
                    </div>
                  </div>
                ...
                <div className="flex items-start justify-between text-xs pt-3 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex items-start space-x-3">
                    <Zap className="w-4 h-4 text-indigo dark:text-indigo-400 shrink-0 mt-0.5" />
                    <div>
                      <h4 className="font-bold text-textPrimary dark:text-slate-100">Calculus III: Practice Set 4</h4>
                      <p className="text-indigo dark:text-indigo-400 font-medium text-[11px]">Today, 4:00 PM - 5:15 PM (Shortened)</p>
                    </div>
                  </div>
                  <span className="text-[9px] font-extrabold bg-teal text-white px-2 py-0.5 rounded-md uppercase">
                    CONSOLIDATED
                ...
                <div className="flex items-start space-x-3 text-xs pt-3 border-t border-slate-100 dark:border-slate-800">
                  <Calendar className="w-4 h-4 text-textSecondary dark:text-slate-400 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-bold text-textPrimary dark:text-slate-100">Linear Algebra: Unit 2</h4>
                    <p className="text-textSecondary dark:text-slate-400 text-[11px]">Tomorrow, 10:00 AM - 11:30 AM</p>
                  </div>
                </div>
              </div>
            </div>
