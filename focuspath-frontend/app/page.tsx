...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#fafbfc] dark:bg-[#0b0f17] text-slate-800 dark:text-slate-100 font-sans antialiased selection:bg-indigo-500 selection:text-white transition-colors">
      ...
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-100 dark:border-slate-800">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-slate-500 dark:text-slate-400">
            <a href="#product" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">Product</a>
            <a href="#adult-mode" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">For Adults</a>
            <a href="#kids-mode" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">For Kids</a>
            <a href="#parent-portal" className="hover:text-slate-900 dark:hover:text-slate-100 transition-colors">For Parents</a>
          </nav>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-16 pb-24 space-y-28">
        ...
        <section id="product" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3">
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-indigo-600 dark:text-indigo-400 block">
                ONE APP, TWO EXPERIENCES.
              </span>
              <h1 className="text-4xl sm:text-5xl lg:text-[54px] font-bold text-slate-900 dark:text-slate-100 tracking-tight leading-[1.12]">
            ...
            <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-normal leading-relaxed max-w-xl">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3.5">
              ...
              <a
                href="#how-it-works"
                className="bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold text-xs sm:text-sm py-3 px-6 rounded-xl border border-slate-200/90 dark:border-slate-700 shadow-xs transition-all"
              >
                See how it works
              </a>
            </div>
          ...
          <div className="lg:col-span-5">
            <div className="rounded-[28px] border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 shadow-xs space-y-6">

              {/* Circular Focus Score Meter */}
              <div className="flex items-center gap-4 border-b border-slate-100 dark:border-slate-800 pb-5">
                <div className="relative h-16 w-16 shrink-0 rounded-full border-4 border-indigo-600 flex items-center justify-center bg-indigo-50/20 dark:bg-indigo-950/40 shadow-xs">
                  <span className="text-xl font-bold text-slate-900 dark:text-slate-100">95</span>
                </div>
                <div>
                  <h3 className="font-bold text-sm text-slate-800 dark:text-slate-100">Focus Score</h3>
                  <p className="text-xs text-slate-400 dark:text-slate-500 font-medium">Top 10% this week</p>
                </div>
              </div>

              {/* Timetable List Slots */}
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/80 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
                  <span className="text-xs font-semibold text-slate-800 dark:text-slate-200">Advanced Mathematics</span>
                  <span className="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-100/70 dark:bg-indigo-950/80 px-2.5 py-0.5 rounded-full">
                    Now
                  </span>
                </div>

                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/60 dark:bg-slate-800/60 border border-slate-100/80 dark:border-slate-700">
                  <span className="text-xs font-semibold text-slate-600 dark:text-slate-300">Deep Focus Grammar</span>
                  <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 font-mono">09:00–10:00</span>
                </div>

                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/60 dark:bg-slate-800/60 border border-slate-100/80 dark:border-slate-700">
                  <span className="text-xs font-semibold text-slate-600 dark:text-slate-300">Language Lab</span>
                  <span className="text-xs font-semibold text-slate-500 dark:text-slate-400 font-mono">11:00–12:00</span>
                </div>
              </div>
        ...
        <section className="space-y-12">
          ...
          <div className="text-center space-y-2 max-w-2xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-normal leading-relaxed pt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-[28px] border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="h-12 w-12 rounded-2xl bg-pink-50 dark:bg-pink-950/60 text-pink-500 dark:text-pink-400 flex items-center justify-center shadow-2xs">
                  <GraduationCap className="h-6 w-6" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">Students & professionals</h3>
            ...
            <div className="rounded-[28px] border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="h-12 w-12 rounded-2xl bg-amber-50 dark:bg-amber-950/60 text-amber-500 dark:text-amber-400 flex items-center justify-center shadow-2xs">
                  <Gamepad2 className="h-6 w-6" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">Kids, with Buddy</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <div className="rounded-[28px] border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 shadow-xs hover:shadow-md transition-all flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="h-12 w-12 rounded-2xl bg-sky-50 dark:bg-sky-950/60 text-sky-500 dark:text-sky-400 flex items-center justify-center shadow-2xs">
                  <Shield className="h-6 w-6" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-base font-bold text-slate-900 dark:text-slate-100">Parents, in control</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <section id="adult-mode" className="rounded-[36px] bg-[#0c1222] text-white p-8 sm:p-12 lg:p-14 shadow-xl relative overflow-hidden border border-slate-800">
        ...
        <section id="kids-mode" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 order-2 lg:order-1">
            <div className="rounded-[28px] border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 p-7 shadow-xs space-y-4">

              {/* Pet / Buddy Avatar indicator */}
              <div className="flex items-center gap-2 pb-1">
                <div className="h-7 w-7 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 flex items-center justify-center text-sm shadow-2xs">
                  🦉
                </div>
                <span className="text-xs font-bold text-slate-800 dark:text-slate-100">Buddy&apos;s Quests</span>
              </div>

              {/* Quest Item 1 */}
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/80 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
                <span className="text-xs font-bold text-slate-800 dark:text-slate-100">Reading Explorer</span>
                <span className="text-[10px] font-bold text-emerald-700 dark:text-emerald-300 bg-emerald-100/80 dark:bg-emerald-950/80 px-2.5 py-0.5 rounded-full">
                  75% Done
                </span>
              </div>
              ...
              {/* Quest Item 2 */}
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/80 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
                <span className="text-xs font-bold text-slate-800 dark:text-slate-100">Math Rocket</span>
                <span className="text-[10px] font-bold text-orange-700 dark:text-orange-300 bg-orange-100/80 dark:bg-orange-950/80 px-2.5 py-0.5 rounded-full">
                  Rank 4
                </span>
              </div>
              ...
              {/* Daily Streak */}
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/80 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
                <span className="text-xs font-bold text-slate-800 dark:text-slate-100">Daily Streak</span>
              ...
              {/* Stars Earned */}
              <div className="flex items-center justify-between p-3.5 rounded-2xl bg-slate-50/80 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
                <span className="text-xs font-bold text-slate-800 dark:text-slate-100">Stars Earned</span>
                <span className="text-xs font-bold text-amber-500 flex items-center gap-1">
          ...
          <div className="lg:col-span-7 space-y-6 order-1 lg:order-2">
            <div className="space-y-2">
              <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-emerald-600 dark:text-emerald-400 block">
                KID&apos;S MODE
              </span>
            ...
            <div className="space-y-3.5 pt-2">
              <div className="flex items-start gap-3">
                <div className="h-5 w-5 rounded-full bg-emerald-100 dark:bg-emerald-950 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shrink-0 mt-0.5">
        ...
        <section id="parent-portal" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3.5 pt-2">
              ...
              {/* Feature 1 */}
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs flex items-start gap-4">
                <div className="h-9 w-9 rounded-xl bg-blue-50 dark:bg-blue-950 text-blue-600 dark:text-blue-400 flex items-center justify-center shrink-0 mt-0.5">
                  <BarChart3 className="h-4 w-4" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-xs font-bold text-slate-900 dark:text-slate-100">Weekly focus, not just screen time</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              {/* Feature 2 */}
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs flex items-start gap-4">
                <div className="h-9 w-9 rounded-xl bg-amber-50 dark:bg-amber-950 text-amber-600 dark:text-amber-400 flex items-center justify-center shrink-0 mt-0.5">
                  <Sliders className="h-4 w-4" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-xs font-bold text-slate-900 dark:text-slate-100">Restrictions you actually set</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              {/* Feature 3 */}
              <div className="p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs flex items-start gap-4">
                <div className="h-9 w-9 rounded-xl bg-pink-50 dark:bg-pink-950 text-pink-600 dark:text-pink-400 flex items-center justify-center shrink-0 mt-0.5">
                  <BellRing className="h-4 w-4" />
                </div>
                <div className="space-y-1">
                  <h4 className="text-xs font-bold text-slate-900 dark:text-slate-100">Real-time access requests</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    When something is blocked, you get the request instantly with context.
                  </p>
                </div>
              </div>
        ...
        <section id="how-it-works" className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-3.5">
              <div className="h-9 w-9 rounded-full bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 font-bold flex items-center justify-center text-xs">
                1
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Pick a mode</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <div className="space-y-3.5">
              ...
              <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Set the guardrails</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <div className="space-y-3.5">
              ...
              <h3 className="text-sm font-bold text-slate-900 dark:text-slate-100">Let it adapt</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <div className="max-w-6xl mx-auto px-6 py-14 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div className="md:col-span-6 space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2">
                ...
                <div className="flex items-center gap-4 text-[11px] font-semibold text-slate-500 dark:text-slate-400">
                  ...
                  <span>•</span>
                  <a href="mailto:support@focuspath.ai" className="hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Report an issue</a>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-3 space-y-3">
              <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500">
                PRODUCT
              </h4>
              <ul className="space-y-2 text-xs font-semibold text-slate-600 dark:text-slate-400">
                <li><Link href="/auth/login?role=ADULT" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Adult Mode</Link></li>
                <li><Link href="/auth/login?role=KID" className="hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">Kid&apos;s Mode</Link></li>
                <li><Link href="/auth/login?role=PARENT" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Parent Portal</Link></li>
              </ul>
            </div>
            ...
            <div className="md:col-span-3 space-y-3">
              ...
              <ul className="space-y-2 text-xs font-semibold text-slate-600 dark:text-slate-400">
                <li><a href="#product" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">About</a></li>
                <li><a href="#how-it-works" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Careers</a></li>
                <li><a href="mailto:contact@focuspath.ai" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Contact</a></li>
              </ul>
            </div>
