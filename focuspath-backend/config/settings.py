...
SECRET_KEY = 'django-insecure-3k^@z$qicb9afylf=^y&0&k*$2*h@+d92gc%=cd8v9!rtprdm('
...
# Override database settings with PostgreSQL if environment variables are set
if os.environ.get('DB_NAME'):
    DATABASES['default'] = {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.environ.get('DB_NAME', 'focuspath'),
